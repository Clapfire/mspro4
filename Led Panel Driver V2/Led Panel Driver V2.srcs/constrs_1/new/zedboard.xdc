...
set_property IOSTANDARD LVCMOS33 [get_ports enc_1_a]
set_property PACKAGE_PIN AB6 [get_ports enc_1_b]
set_property IOSTANDARD LVCMOS33 [get_ports enc_1_b]
set_property PACKAGE_PIN Y4 [get_ports enc_1_sw]
set_property IOSTANDARD LVCMOS33 [get_ports enc_1_sw]
set_property PACKAGE_PIN AA4 [get_ports enc_1_btn]
set_property IOSTANDARD LVCMOS33 [get_ports enc_1_btn]
set_property PACKAGE_PIN V7 [get_ports enc_2_a]
set_property IOSTANDARD LVCMOS33 [get_ports enc_2_a]
set_property PACKAGE_PIN W7 [get_ports enc_2_b]
set_property IOSTANDARD LVCMOS33 [get_ports enc_2_b]
set_property PACKAGE_PIN V4 [get_ports enc_2_sw]
set_property IOSTANDARD LVCMOS33 [get_ports enc_2_sw]
set_property PACKAGE_PIN V5 [get_ports enc_2_btn]
set_property IOSTANDARD LVCMOS33 [get_ports enc_2_btn]
